...
export default function Footer() {
    return (
        <div className={styles.footer}>
            <div>
                <h1>RESOURCES</h1>
                <input type="button" value="Learn More ▷" className={styles.button1} />
            </div>
            <div>
                <div>
                    <ul>
                ...
                <div>
                    <div>
                        <span>
                            <input type="button" value="uber" className={styles.button1} />
                        </span>
                        <span>
                            <input type="button" value="didi" className={styles.button1} />
                        </span>
                        <span >
                            <input type="button" value="grab" className={styles.button1} />
                        </span>
                    </div>
                </div>
            </div>
